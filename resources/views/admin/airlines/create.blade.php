...
<div class="container">
    <div class="card-form">
        <h3>✈️ Tambah Maskapai</h3>
        <p class="subtitle">Masukkan data maskapai penerbangan baru</p>
        ...
        <form action="{{ route('airlines.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="nama" id="nama" placeholder="Contoh: Garuda Indonesia" value="{{ old('nama') }}" required>
            </div>

            <div class="form-group">
                <label for="kode"><i class="fas fa-tag form-icon"></i> Kode Maskapai <span class="required">*</span></label>
                <input type="text" name="kode" id="kode" placeholder="Contoh: GA" value="{{ old('kode') }}" required maxlength="5">
            ...
            <div class="form-group">
                ...
                <textarea name="deskripsi" id="deskripsi" rows="2" placeholder="Masukkan deskripsi maskapai">{{ old('deskripsi') }}</textarea>
            </div>

            <div class="form-group">
                <label for="logo"><i class="fas fa-image form-icon"></i> Logo URL (Opsional)</label>
                <input type="text" name="logo" id="logo" placeholder="https://example.com/logo.png" value="{{ old('logo') }}">
            </div>

            <div class="btn-group">
                <button type="submit" class="btn-submit"><i class="fas fa-save"></i> Simpan Maskapai</button>
